...
{</xsl:text><xsl:text>"title":"Catalog Services for the Web (CSW) Core Queryables",</xsl:text><xsl:text>"code":"CSWCoreQueryables",</xsl:text><xsl:text>"description":"The Open Geospatial Consortium Catalog Services for the Web (CSW) standard defines 11 Core Queryables that must be supported in any compliant implementation. Profiles of CSW map these queryables to concepts and xPaths for particular metadata dialects. For additional reference information see the ISO Profile of CSW (Table 6).",</xsl:text><xsl:text>"maximum":"10",</xsl:text><xsl:variable name="CSWCoreQueryables.itemExists" as="xs:integer+"><xsl:sequence select="if(exists(/metadata/idinfo/keywords/theme/themekey)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/metadata/idinfo/citation/citeinfo/title)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/metadata/idinfo/descript/abstract)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/metadata/distInfo/distributor/distorFormat/formatName | /metadata/distinfo/stdorder/digform/digtinfo/formname)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/metadata/metainfo/metd)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/metadata/distinfo/resdesc)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/metadata/idinfo/spdom/bounding)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'existTotal'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($CSWCoreQueryables.itemExists)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="CSWCoreQueryables.itemCounts" as="xs:integer+"><xsl:sequence select="count(/metadata/idinfo/keywords/theme/themekey)"></xsl:sequence><xsl:sequence select="count(/metadata/idinfo/citation/citeinfo/title)"></xsl:sequence><xsl:sequence select="count(/metadata/idinfo/descript/abstract)"></xsl:sequence><xsl:sequence select="count(/metadata/distInfo/distributor/distorFormat/formatName) + count(/metadata/distinfo/stdorder/digform/digtinfo/formname)"></xsl:sequence><xsl:sequence select="count(/metadata/metainfo/metd)"></xsl:sequence><xsl:sequence select="count(/metadata/distinfo/resdesc)"></xsl:sequence><xsl:sequence select="count(/metadata/idinfo/spdom/bounding)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'countTotal'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($CSWCoreQueryables.itemCounts)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"items" : [
</xsl:text><xsl:text>{
</xsl:text><xsl:text>"name":"Keyword",</xsl:text><xsl:variable name="CSWCoreQueryables.itemExists.d1e12800" as="xs:integer+"><xsl:sequence select="if(exists(/metadata/idinfo/keywords/theme/themekey)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($CSWCoreQueryables.itemExists.d1e12800)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="CSWCoreQueryables.itemCounts.d1e12800" as="xs:integer+"><xsl:sequence select="count(/metadata/idinfo/keywords/theme/themekey)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($CSWCoreQueryables.itemCounts.d1e12800)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Resource Format",</xsl:text><xsl:variable name="CSWCoreQueryables.itemExists.d1e4713" as="xs:integer+"><xsl:sequence select="if(exists(/metadata/distInfo/distributor/distorFormat/formatName | /metadata/distinfo/stdorder/digform/digtinfo/formname)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($CSWCoreQueryables.itemExists.d1e4713)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="CSWCoreQueryables.itemCounts.d1e4713" as="xs:integer+"><xsl:sequence select="count(/metadata/distInfo/distributor/distorFormat/formatName | /metadata/distinfo/stdorder/digform/digtinfo/formname)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($CSWCoreQueryables.itemCounts.d1e4713)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Metadata Modified Date",</xsl:text><xsl:variable name="CSWCoreQueryables.itemExists.d1e4437" as="xs:integer+"><xsl:sequence select="if(exists(/metadata/metainfo/metd)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($CSWCoreQueryables.itemExists.d1e4437)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="CSWCoreQueryables.itemCounts.d1e4437" as="xs:integer+"><xsl:sequence select="count(/metadata/metainfo/metd)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($CSWCoreQueryables.itemCounts.d1e4437)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
{</xsl:text><xsl:text>"title":"Catalog Services for the Web (CSW) Core Returnable Properties",</xsl:text><xsl:text>"code":"CSWCoreReturnables",</xsl:text><xsl:text>"description":"The Open Geospatial Consortium Catalog Services for the Web (CSW) standard defines 15 Core Returnables that must be supported in any compliant implementation. Profiles of CSW map these queryables to concepts and xPaths for particular metadata dialects. For additional reference information see the ISO Profile of CSW (Table 9).",</xsl:text><xsl:text>"maximum":"15",</xsl:text><xsl:variable name="CSWCoreReturnables.itemExists" as="xs:integer+"><xsl:sequence select="if(exists(/metadata/idinfo/citation/citeinfo/title)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/metadata/idinfo/citation/citeinfo/origin)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/metadata/idinfo/keywords/theme/themekey)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/metadata/idinfo/descript/abstract)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/metadata/idinfo/citation/citeinfo/pubinfo/publish)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/metadata/idinfo/citation/citeinfo/origin | /metadata/idinfo/datacred | /metadata/metainfo/metc/cntinfo)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/metadata/metainfo/metd)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/metadata/distinfo/resdesc)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/metadata/distInfo/distributor/distorFormat/formatName | /metadata/distinfo/stdorder/digform/digtinfo/formname)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/metadata/dataqual/lineage/srcinfo/srccite)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/metadata/metainfo/metstdn)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/metadata/idinfo/citation/citeinfo/lworkcit)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/metadata/idinfo/spdom/bounding)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/metadata/idinfo/accconst | /metadata/idinfo/useconst | /metadata/metainfo/metac | /metadata/metainfo/metuc)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'existTotal'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($CSWCoreReturnables.itemExists)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="CSWCoreReturnables.itemCounts" as="xs:integer+"><xsl:sequence select="count(/metadata/idinfo/citation/citeinfo/title)"></xsl:sequence><xsl:sequence select="count(/metadata/idinfo/citation/citeinfo/origin)"></xsl:sequence><xsl:sequence select="count(/metadata/idinfo/keywords/theme/themekey)"></xsl:sequence><xsl:sequence select="count(/metadata/idinfo/descript/abstract)"></xsl:sequence><xsl:sequence select="count(/metadata/idinfo/citation/citeinfo/pubinfo/publish)"></xsl:sequence><xsl:sequence select="count(/metadata/idinfo/citation/citeinfo/origin) + count(/metadata/idinfo/datacred) + count(/metadata/metainfo/metc/cntinfo)"></xsl:sequence><xsl:sequence select="count(/metadata/metainfo/metd)"></xsl:sequence><xsl:sequence select="count(/metadata/distinfo/resdesc)"></xsl:sequence><xsl:sequence select="count(/metadata/distInfo/distributor/distorFormat/formatName) + count(/metadata/distinfo/stdorder/digform/digtinfo/formname)"></xsl:sequence><xsl:sequence select="count(/metadata/dataqual/lineage/srcinfo/srccite)"></xsl:sequence><xsl:sequence select="count(/metadata/metainfo/metstdn)"></xsl:sequence><xsl:sequence select="count(/metadata/idinfo/citation/citeinfo/lworkcit)"></xsl:sequence><xsl:sequence select="count(/metadata/idinfo/spdom/bounding)"></xsl:sequence><xsl:sequence select="count(/metadata/idinfo/accconst) + count(/metadata/idinfo/useconst) + count(/metadata/metainfo/metac) + count(/metadata/metainfo/metuc)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'countTotal'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($CSWCoreReturnables.itemCounts)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"items" : [
</xsl:text><xsl:text>{
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Author / Originator",</xsl:text><xsl:variable name="CSWCoreReturnables.itemExists.d1e3947" as="xs:integer+"><xsl:sequence select="if(exists(/metadata/idinfo/citation/citeinfo/origin)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($CSWCoreReturnables.itemExists.d1e3947)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="CSWCoreReturnables.itemCounts.d1e3947" as="xs:integer+"><xsl:sequence select="count(/metadata/idinfo/citation/citeinfo/origin)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($CSWCoreReturnables.itemCounts.d1e3947)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Keyword",</xsl:text><xsl:variable name="CSWCoreReturnables.itemExists.d1e12800" as="xs:integer+"><xsl:sequence select="if(exists(/metadata/idinfo/keywords/theme/themekey)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($CSWCoreReturnables.itemExists.d1e12800)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="CSWCoreReturnables.itemCounts.d1e12800" as="xs:integer+"><xsl:sequence select="count(/metadata/idinfo/keywords/theme/themekey)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($CSWCoreReturnables.itemCounts.d1e12800)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
{</xsl:text><xsl:text>"path":"/metadata/idinfo/keywords/theme/themekey",</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="if(exists(/metadata/idinfo/keywords/theme/themekey)) then 1 else 0"></xsl:value-of><xsl:text>",
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Publisher",</xsl:text><xsl:variable name="CSWCoreReturnables.itemExists.d1e2221" as="xs:integer+"><xsl:sequence select="if(exists(/metadata/idinfo/citation/citeinfo/pubinfo/publish)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($CSWCoreReturnables.itemExists.d1e2221)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="CSWCoreReturnables.itemCounts.d1e2221" as="xs:integer+"><xsl:sequence select="count(/metadata/idinfo/citation/citeinfo/pubinfo/publish)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($CSWCoreReturnables.itemCounts.d1e2221)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Contributor Name",</xsl:text><xsl:variable name="CSWCoreReturnables.itemExists.d1e4650" as="xs:integer+"><xsl:sequence select="if(exists(/metadata/idinfo/citation/citeinfo/origin | /metadata/idinfo/datacred | /metadata/metainfo/metc/cntinfo)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($CSWCoreReturnables.itemExists.d1e4650)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="CSWCoreReturnables.itemCounts.d1e4650" as="xs:integer+"><xsl:sequence select="count(/metadata/idinfo/citation/citeinfo/origin | /metadata/idinfo/datacred | /metadata/metainfo/metc/cntinfo)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($CSWCoreReturnables.itemCounts.d1e4650)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
{</xsl:text><xsl:text>"path":"/metadata/idinfo/citation/citeinfo/origin",</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="if(exists(/metadata/idinfo/citation/citeinfo/origin)) then 1 else 0"></xsl:value-of><xsl:text>",
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Metadata Modified Date",</xsl:text><xsl:variable name="CSWCoreReturnables.itemExists.d1e4437" as="xs:integer+"><xsl:sequence select="if(exists(/metadata/metainfo/metd)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($CSWCoreReturnables.itemExists.d1e4437)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="CSWCoreReturnables.itemCounts.d1e4437" as="xs:integer+"><xsl:sequence select="count(/metadata/metainfo/metd)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($CSWCoreReturnables.itemCounts.d1e4437)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
{</xsl:text><xsl:text>"path":"/metadata/metainfo/metd",</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="if(exists(/metadata/metainfo/metd)) then 1 else 0"></xsl:value-of><xsl:text>",
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Resource Format",</xsl:text><xsl:variable name="CSWCoreReturnables.itemExists.d1e4713" as="xs:integer+"><xsl:sequence select="if(exists(/metadata/distInfo/distributor/distorFormat/formatName | /metadata/distinfo/stdorder/digform/digtinfo/formname)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($CSWCoreReturnables.itemExists.d1e4713)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="CSWCoreReturnables.itemCounts.d1e4713" as="xs:integer+"><xsl:sequence select="count(/metadata/distInfo/distributor/distorFormat/formatName | /metadata/distinfo/stdorder/digform/digtinfo/formname)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($CSWCoreReturnables.itemCounts.d1e4713)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
{</xsl:text><xsl:text>"path":"/metadata/distInfo/distributor/distorFormat/formatName",</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="if(exists(/metadata/distInfo/distributor/distorFormat/formatName)) then 1 else 0"></xsl:value-of><xsl:text>",
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Source Citation",</xsl:text><xsl:variable name="CSWCoreReturnables.itemExists.d1e9320" as="xs:integer+"><xsl:sequence select="if(exists(/metadata/dataqual/lineage/srcinfo/srccite)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($CSWCoreReturnables.itemExists.d1e9320)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="CSWCoreReturnables.itemCounts.d1e9320" as="xs:integer+"><xsl:sequence select="count(/metadata/dataqual/lineage/srcinfo/srccite)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($CSWCoreReturnables.itemCounts.d1e9320)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Related Resource Citation",</xsl:text><xsl:variable name="CSWCoreReturnables.itemExists.d1e9231" as="xs:integer+"><xsl:sequence select="if(exists(/metadata/idinfo/citation/citeinfo/lworkcit)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($CSWCoreReturnables.itemExists.d1e9231)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="CSWCoreReturnables.itemCounts.d1e9231" as="xs:integer+"><xsl:sequence select="count(/metadata/idinfo/citation/citeinfo/lworkcit)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($CSWCoreReturnables.itemCounts.d1e9231)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
{</xsl:text><xsl:text>"path":"/metadata/idinfo/citation/citeinfo/lworkcit",</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="if(exists(/metadata/idinfo/citation/citeinfo/lworkcit)) then 1 else 0"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>"</xsl:text><xsl:text>:</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="count(/metadata/idinfo/citation/citeinfo/lworkcit)"></xsl:value-of><xsl:text>"
</xsl:text><xsl:text>}</xsl:text><xsl:text>],
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Rights",</xsl:text><xsl:variable name="CSWCoreReturnables.itemExists.d1e4842" as="xs:integer+"><xsl:sequence select="if(exists(/metadata/idinfo/accconst | /metadata/idinfo/useconst | /metadata/metainfo/metac | /metadata/metainfo/metuc)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($CSWCoreReturnables.itemExists.d1e4842)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="CSWCoreReturnables.itemCounts.d1e4842" as="xs:integer+"><xsl:sequence select="count(/metadata/idinfo/accconst | /metadata/idinfo/useconst | /metadata/metainfo/metac | /metadata/metainfo/metuc)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($CSWCoreReturnables.itemCounts.d1e4842)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
{</xsl:text><xsl:text>"title":"Catalog Service for the Web (CSW) Additional Queryable Properties",</xsl:text><xsl:text>"code":"CSWAdditionalQueryables",</xsl:text><xsl:text>"description":"The Open Geospatial Consortium Catalog Services for the Web (CSW) standard supports 10 Additional Queryable search parameters. Profiles of CSW map these queryables to concepts and xPaths for particular metadata dialects. For additional reference information see the ISO Profile of CSW (Table 10).",</xsl:text><xsl:text>"maximum":"9",</xsl:text><xsl:variable name="CSWAdditionalQueryables.itemExists" as="xs:integer+"><xsl:sequence select="if(exists(/metadata/idinfo/citation/citeinfo/pubdate)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/metadata/idinfo/citation/citeinfo/pubdate)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/metadata/idinfo/citation/citeinfo/origin)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/metadata/idinfo/secinfo)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/metadata/metainfo/metstdn)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/metadata/idinfo/keywords/theme/themekt)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'existTotal'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($CSWAdditionalQueryables.itemExists)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="CSWAdditionalQueryables.itemCounts" as="xs:integer+"><xsl:sequence select="count(/metadata/idinfo/citation/citeinfo/pubdate)"></xsl:sequence><xsl:sequence select="count(/metadata/idinfo/citation/citeinfo/pubdate)"></xsl:sequence><xsl:sequence select="count(/metadata/idinfo/citation/citeinfo/origin)"></xsl:sequence><xsl:sequence select="count(/metadata/idinfo/secinfo)"></xsl:sequence><xsl:sequence select="count(/metadata/metainfo/metstdn)"></xsl:sequence><xsl:sequence select="count(/metadata/idinfo/keywords/theme/themekt)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'countTotal'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($CSWAdditionalQueryables.itemCounts)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"items" : [
</xsl:text><xsl:text>{
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Publication Date",</xsl:text><xsl:variable name="CSWAdditionalQueryables.itemExists.d1e2098" as="xs:integer+"><xsl:sequence select="if(exists(/metadata/idinfo/citation/citeinfo/pubdate)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($CSWAdditionalQueryables.itemExists.d1e2098)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="CSWAdditionalQueryables.itemCounts.d1e2098" as="xs:integer+"><xsl:sequence select="count(/metadata/idinfo/citation/citeinfo/pubdate)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($CSWAdditionalQueryables.itemCounts.d1e2098)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
{</xsl:text><xsl:text>"path":"/metadata/idinfo/citation/citeinfo/pubdate",</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="if(exists(/metadata/idinfo/citation/citeinfo/pubdate)) then 1 else 0"></xsl:value-of><xsl:text>",
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Security Constraints",</xsl:text><xsl:variable name="CSWAdditionalQueryables.itemExists.d1e4935" as="xs:integer+"><xsl:sequence select="if(exists(/metadata/idinfo/secinfo)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($CSWAdditionalQueryables.itemExists.d1e4935)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="CSWAdditionalQueryables.itemCounts.d1e4935" as="xs:integer+"><xsl:sequence select="count(/metadata/idinfo/secinfo)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($CSWAdditionalQueryables.itemCounts.d1e4935)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
{</xsl:text><xsl:text>"path":"/metadata/idinfo/secinfo",</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="if(exists(/metadata/idinfo/secinfo)) then 1 else 0"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>"</xsl:text><xsl:text>:</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="count(/metadata/idinfo/secinfo)"></xsl:value-of><xsl:text>"
</xsl:text><xsl:text>}</xsl:text><xsl:text>],
</xsl:text><xsl:text>"description":"Handling restrictions imposed on the resource or metadata for national security or similar security concerns."</xsl:text><xsl:text>}</xsl:text>,
<xsl:text>{
