...
{</xsl:text><xsl:text>"title":"UMM-Common Required",</xsl:text><xsl:text>"code":"UMM-Common_Required",</xsl:text><xsl:text>"description":"The NASA Unified Metadata Model/Mapping (UMM) includes a profile for elements that are common to all of the UMM Profiles, the UMM-Common Profile. These are the elements required by that profile.",</xsl:text><xsl:text>"maximum":"23",</xsl:text><xsl:variable name="UMM-Common_Required.itemExists" as="xs:integer+"><xsl:sequence select="if(exists(/dryad:DryadDataFile/dcterms:title)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/dryad:DryadDataFile/dcterms:description)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/dryad:DryadDataFile/dcterms:spatial)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/dryad:DryadDataFile/dcterms:temporal | /dryad:DryadDataFile/dcterms:temporal)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'existTotal'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($UMM-Common_Required.itemExists)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="UMM-Common_Required.itemCounts" as="xs:integer+"><xsl:sequence select="count(/dryad:DryadDataFile/dcterms:title)"></xsl:sequence><xsl:sequence select="count(/dryad:DryadDataFile/dcterms:description)"></xsl:sequence><xsl:sequence select="count(/dryad:DryadDataFile/dcterms:spatial)"></xsl:sequence><xsl:sequence select="count(/dryad:DryadDataFile/dcterms:temporal) + count(/dryad:DryadDataFile/dcterms:temporal)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'countTotal'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($UMM-Common_Required.itemCounts)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"items" : [
</xsl:text><xsl:text>{
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Resource Title",</xsl:text><xsl:variable name="UMM-Common_Required.itemExists.d1e314" as="xs:integer+"><xsl:sequence select="if(exists(/dryad:DryadDataFile/dcterms:title)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($UMM-Common_Required.itemExists.d1e314)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="UMM-Common_Required.itemCounts.d1e314" as="xs:integer+"><xsl:sequence select="count(/dryad:DryadDataFile/dcterms:title)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($UMM-Common_Required.itemCounts.d1e314)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Abstract",</xsl:text><xsl:variable name="UMM-Common_Required.itemExists.d1e573" as="xs:integer+"><xsl:sequence select="if(exists(/dryad:DryadDataFile/dcterms:description)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($UMM-Common_Required.itemExists.d1e573)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="UMM-Common_Required.itemCounts.d1e573" as="xs:integer+"><xsl:sequence select="count(/dryad:DryadDataFile/dcterms:description)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($UMM-Common_Required.itemCounts.d1e573)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Spatial Extent",</xsl:text><xsl:variable name="UMM-Common_Required.itemExists.d1e7908" as="xs:integer+"><xsl:sequence select="if(exists(/dryad:DryadDataFile/dcterms:spatial)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($UMM-Common_Required.itemExists.d1e7908)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="UMM-Common_Required.itemCounts.d1e7908" as="xs:integer+"><xsl:sequence select="count(/dryad:DryadDataFile/dcterms:spatial)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($UMM-Common_Required.itemCounts.d1e7908)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Temporal Extent",</xsl:text><xsl:variable name="UMM-Common_Required.itemExists.d1e6497" as="xs:integer+"><xsl:sequence select="if(exists(/dryad:DryadDataFile/dcterms:temporal | /dryad:DryadDataFile/dcterms:temporal)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($UMM-Common_Required.itemExists.d1e6497)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="UMM-Common_Required.itemCounts.d1e6497" as="xs:integer+"><xsl:sequence select="count(/dryad:DryadDataFile/dcterms:temporal | /dryad:DryadDataFile/dcterms:temporal)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($UMM-Common_Required.itemCounts.d1e6497)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
{</xsl:text><xsl:text>"title":"UMM-Common Optional",</xsl:text><xsl:text>"code":"UMM-Common_Optional",</xsl:text><xsl:text>"description":"The NASA Unified Metadata Model/Mapping (UMM) includes a profile for elements that are common to all of the UMM Profiles, the UMM-Common Profile. These are the optional elements included in that profile.",</xsl:text><xsl:text>"maximum":"15",</xsl:text><xsl:variable name="UMM-Common_Optional.itemExists" as="xs:integer+"><xsl:sequence select="if(exists(/dryad:DryadDataFile/dcterms:dateSubmitted | /dryad:DryadDataFile/dcterms:available)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'existTotal'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($UMM-Common_Optional.itemExists)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="UMM-Common_Optional.itemCounts" as="xs:integer+"><xsl:sequence select="count(/dryad:DryadDataFile/dcterms:dateSubmitted) + count(/dryad:DryadDataFile/dcterms:available)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'countTotal'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($UMM-Common_Optional.itemCounts)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"items" : [
</xsl:text><xsl:text>{
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Resource Creation/Revision Date",</xsl:text><xsl:variable name="UMM-Common_Optional.itemExists.d1e447" as="xs:integer+"><xsl:sequence select="if(exists(/dryad:DryadDataFile/dcterms:dateSubmitted | /dryad:DryadDataFile/dcterms:available)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($UMM-Common_Optional.itemExists.d1e447)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="UMM-Common_Optional.itemCounts.d1e447" as="xs:integer+"><xsl:sequence select="count(/dryad:DryadDataFile/dcterms:dateSubmitted | /dryad:DryadDataFile/dcterms:available)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($UMM-Common_Optional.itemCounts.d1e447)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
