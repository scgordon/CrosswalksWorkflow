...
{</xsl:text><xsl:text>"title":"FGDC for Data Discovery - Mandatory",</xsl:text><xsl:text>"code":"FGDC_Mandatory",</xsl:text><xsl:text>"description":"The FGDC Content Standard for Digital Geospatial Metadata includes fields in the Identification Information and Metadata Reference Sections that are mandatory for data discovery. In the graphical representation of the standard, these are yellow fields included in yellow sections.",</xsl:text><xsl:text>"maximum":"20",</xsl:text><xsl:variable
            name="FGDC_Mandatory.itemExists" as="xs:integer+"><xsl:sequence select="
                    ...
                    if (exists(/eml:eml/dataset/creator/organizationName)) then
                        1
                    else
                        0"/><xsl:sequence
                select="
                ...
                select="
                    if (exists(/eml:eml/dataset/purpose)) then
                        ...
                        0"/><xsl:sequence select="
                    if (exists(/eml:eml/dataset/maintenance/maintenanceUpdateFrequency)) then
                        1
                    else
                        0"/><xsl:sequence
                select="
...
</xsl:text><xsl:variable name="FGDC_Mandatory.itemCounts" as="xs:integer+"><xsl:sequence select="count(/eml:eml/dataset/title)"
                /><xsl:sequence select="count(/eml:eml/dataset/creator/organizationName)"/><xsl:sequence select="count(/eml:eml/dataset/pubDate)"/><xsl:sequence select="count(/eml:eml/dataset/abstract) + count(/eml:eml/dataset/abstract)"/><xsl:sequence select="count(/eml:eml/dataset/purpose)"/><xsl:sequence select="count(/eml:eml/dataset/maintenance/maintenanceUpdateFrequency)"/><xsl:sequence
                select="count(/eml:eml/dataset/coverage/temporalCoverage)"/><xsl:sequence select="count(/eml:eml/dataset/coverage/geographicCoverage/boundingCoordinates)"/><xsl:sequence select="count(/eml:eml/access)"/><xsl:sequence select="count(/eml:eml/dataset/intellectualRights)"/><xsl:sequence select="count(/eml:eml/dataset/keywordSet/keyword)"/><xsl:sequence
                select="count(/eml:eml/dataset/associatedParty/role[RoleType = 'distributor'])"/><xsl:sequence select="count(/eml:eml/dataset/metadataProvider)"/></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'countTotal'"/><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemCounts)"/><xsl:text>",
</xsl:text><xsl:text>
"items" : [
</xsl:text><xsl:text>{
</xsl:text><xsl:text>"name":"Resource Title",</xsl:text><xsl:variable
            name="FGDC_Mandatory.itemExists.d1e314" as="xs:integer+"><xsl:sequence select="
                    if (exists(/eml:eml/dataset/title)) then
                        1
                    else
                        0"/></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"/><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemExists.d1e314)"/><xsl:text>",
</xsl:text><xsl:variable name="FGDC_Mandatory.itemCounts.d1e314" as="xs:integer+"
                ><xsl:sequence select="count(/eml:eml/dataset/title)"/></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"/><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemCounts.d1e314)"/><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
</xsl:text><xsl:text>"name":"Originating Organization",</xsl:text><xsl:variable name="FGDC_Mandatory.itemExists.d1e4060" as="xs:integer+"><xsl:sequence
                select="
                    if (exists(/eml:eml/dataset/creator/organizationName)) then
                        1
                    else
                        0"/></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"/><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemExists.d1e4060)"/><xsl:text>",
</xsl:text><xsl:variable name="FGDC_Mandatory.itemCounts.d1e4060" as="xs:integer+"><xsl:sequence
                select="count(/eml:eml/dataset/creator/organizationName)"/></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"/><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemCounts.d1e4060)"/><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
{</xsl:text><xsl:text>"path":"/eml:eml/dataset/creator/organizationName",</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'exists'"
            /><xsl:text>":"</xsl:text><xsl:value-of select="
                if (exists(/eml:eml/dataset/creator/organizationName)) then
                    1
                else
                    0"/><xsl:text>",
</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'count'"/><xsl:text>"</xsl:text><xsl:text>:</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="count(/eml:eml/dataset/creator/organizationName)"
        /><xsl:text>"
</xsl:text><xsl:text>}</xsl:text><xsl:text>],
...
</xsl:text><xsl:variable name="FGDC_Mandatory.itemCounts.d1e2098" as="xs:integer+"><xsl:sequence select="count(/eml:eml/dataset/pubDate)"
            /></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"/><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemCounts.d1e2098)"/><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
</xsl:text><xsl:text>"name":"Abstract",</xsl:text><xsl:variable name="FGDC_Mandatory.itemExists.d1e573" as="xs:integer+"><xsl:sequence
                select="
                    if (exists(/eml:eml/dataset/abstract | /eml:eml/dataset/abstract)) then
                        1
                    else
                        0"/></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"/><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemExists.d1e573)"/><xsl:text>",
</xsl:text><xsl:variable name="FGDC_Mandatory.itemCounts.d1e573" as="xs:integer+"><xsl:sequence
                select="count(/eml:eml/dataset/abstract | /eml:eml/dataset/abstract)"/></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"/><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemCounts.d1e573)"/><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
{</xsl:text><xsl:text>"path":"/eml:eml/dataset/abstract",</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'exists'"/><xsl:text>":"</xsl:text><xsl:value-of select="
            ...
            name="FGDC_Mandatory.itemExists.d1e3010" as="xs:integer+"><xsl:sequence select="
                ...
                ><xsl:sequence select="count(/eml:eml/dataset/purpose)"/></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"/><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemCounts.d1e3010)"/><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
{</xsl:text><xsl:text>"path":"/eml:eml/dataset/purpose",</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'exists'"/><xsl:text>":"</xsl:text><xsl:value-of
            select="
                if (exists(/eml:eml/dataset/purpose)) then
                    1
                else
                    0"/><xsl:text>",
</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'count'"/><xsl:text>"</xsl:text><xsl:text>:</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="count(/eml:eml/dataset/purpose)"
        /><xsl:text>"
</xsl:text><xsl:text>}</xsl:text><xsl:text>],
            ...
            select="sum($FGDC_Mandatory.itemExists.d1e6964)"/><xsl:text>",
</xsl:text><xsl:variable name="FGDC_Mandatory.itemCounts.d1e6964" as="xs:integer+"><xsl:sequence select="count(/eml:eml/dataset/maintenance/maintenanceUpdateFrequency)"/></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"/><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemCounts.d1e6964)"
            /><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
{</xsl:text><xsl:text>"path":"/eml:eml/dataset/maintenance/maintenanceUpdateFrequency",</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'exists'"/><xsl:text>":"</xsl:text><xsl:value-of select="
                if (exists(/eml:eml/dataset/maintenance/maintenanceUpdateFrequency)) then
                    1
                else
                    0"
            /><xsl:text>",
</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'count'"/><xsl:text>"</xsl:text><xsl:text>:</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="count(/eml:eml/dataset/maintenance/maintenanceUpdateFrequency)"/><xsl:text>"
</xsl:text><xsl:text>}</xsl:text><xsl:text>],
            ...
            <xsl:text>{
</xsl:text><xsl:text>"name":"Temporal Extent",</xsl:text><xsl:variable name="FGDC_Mandatory.itemExists.d1e6497" as="xs:integer+"><xsl:sequence select="
                    if (exists(/eml:eml/dataset/coverage/temporalCoverage)) then
                        1
                    else
                        0"/></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"/><xsl:text>":"</xsl:text><xsl:value-of
            select="sum($FGDC_Mandatory.itemExists.d1e6497)"/><xsl:text>",
</xsl:text><xsl:variable name="FGDC_Mandatory.itemCounts.d1e6497" as="xs:integer+"><xsl:sequence select="count(/eml:eml/dataset/coverage/temporalCoverage)"/></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"/><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemCounts.d1e6497)"
            /><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
{</xsl:text><xsl:text>"path":"/eml:eml/dataset/coverage/temporalCoverage",</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'exists'"/><xsl:text>":"</xsl:text><xsl:value-of select="
            ...
            select="'count'"/><xsl:text>"</xsl:text><xsl:text>:</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="count(/eml:eml/dataset/coverage/temporalCoverage)"/><xsl:text>"
</xsl:text><xsl:text>}</xsl:text><xsl:text>],
</xsl:text><xsl:text>"description":"The temporal extent of the resource"</xsl:text><xsl:text>}</xsl:text>, <xsl:text>{
</xsl:text><xsl:text>"name":"Bounding Box",</xsl:text><xsl:variable name="FGDC_Mandatory.itemExists.d1e4489" as="xs:integer+"><xsl:sequence
                select="
                    if (exists(/eml:eml/dataset/coverage/geographicCoverage/boundingCoordinates)) then
                        1
                    else
                        0"/></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"/><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemExists.d1e4489)"/><xsl:text>",
</xsl:text><xsl:variable name="FGDC_Mandatory.itemCounts.d1e4489" as="xs:integer+"><xsl:sequence
                select="count(/eml:eml/dataset/coverage/geographicCoverage/boundingCoordinates)"/></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"/><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemCounts.d1e4489)"/><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
{</xsl:text><xsl:text>"path":"/eml:eml/dataset/coverage/geographicCoverage/boundingCoordinates",</xsl:text><xsl:text>"</xsl:text><xsl:value-of
            ...
            select="count(/eml:eml/dataset/coverage/geographicCoverage/boundingCoordinates)"/><xsl:text>"
</xsl:text><xsl:text>}</xsl:text><xsl:text>],
...
</xsl:text><xsl:text>"name":"Resource Access Constraints",</xsl:text><xsl:variable
            name="FGDC_Mandatory.itemExists.d1e5017" as="xs:integer+"><xsl:sequence select="
                    if (exists(/eml:eml/access)) then
                        1
                    else
                        0"/></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"/><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemExists.d1e5017)"/><xsl:text>",
</xsl:text><xsl:variable name="FGDC_Mandatory.itemCounts.d1e5017" as="xs:integer+"><xsl:sequence
                select="count(/eml:eml/access)"/></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"/><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemCounts.d1e5017)"/><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
{</xsl:text><xsl:text>"path":"/eml:eml/access",</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'exists'"/><xsl:text>":"</xsl:text><xsl:value-of
            select="
                if (exists(/eml:eml/access)) then
                    1
                else
        ...
        /><xsl:text>"
            ...
            <xsl:text>{
                    ...
                    if (exists(/eml:eml/dataset/intellectualRights)) then
                        ...
                        0"/></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"/><xsl:text>":"</xsl:text><xsl:value-of
            select="sum($FGDC_Mandatory.itemExists.d1e5086)"/><xsl:text>",
</xsl:text><xsl:variable name="FGDC_Mandatory.itemCounts.d1e5086" as="xs:integer+"><xsl:sequence select="count(/eml:eml/dataset/intellectualRights)"/></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"/><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemCounts.d1e5086)"
            /><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
{</xsl:text><xsl:text>"path":"/eml:eml/dataset/intellectualRights",</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'exists'"/><xsl:text>":"</xsl:text><xsl:value-of select="
        ...
        /><xsl:text>"
            ...
            /><xsl:text>",
</xsl:text><xsl:variable name="FGDC_Mandatory.itemCounts.d1e12800" as="xs:integer+"><xsl:sequence select="count(/eml:eml/dataset/keywordSet/keyword)"/></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"/><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemCounts.d1e12800)"
            /><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
{</xsl:text><xsl:text>"path":"/eml:eml/dataset/keywordSet/keyword",</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'exists'"/><xsl:text>":"</xsl:text><xsl:value-of select="
        ...
        <xsl:text>{
</xsl:text><xsl:text>"name":"Distribution Liability",</xsl:text><xsl:text>"exists":"-1",</xsl:text><xsl:text>"count":"-1",</xsl:text><xsl:text>"description":"Statement of the liability assumed by the distributor."</xsl:text><xsl:text>}</xsl:text>, <xsl:text>{
...
</xsl:text><xsl:variable name="FGDC_Mandatory.itemCounts.d1e5416" as="xs:integer+"><xsl:sequence
                select="count(/eml:eml/dataset/associatedParty/role[RoleType = 'distributor'])"/></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"/><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemCounts.d1e5416)"/><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
{</xsl:text><xsl:text>"path":"/eml:eml/dataset/associatedParty/role[RoleType='distributor']",</xsl:text><xsl:text>"</xsl:text><xsl:value-of
            select="'exists'"/><xsl:text>":"</xsl:text><xsl:value-of select="
                if (exists(/eml:eml/dataset/associatedParty/role[RoleType = 'distributor'])) then
                    1
                else
            ...
            select="count(/eml:eml/dataset/associatedParty/role[RoleType = 'distributor'])"/><xsl:text>"
</xsl:text><xsl:text>}</xsl:text><xsl:text>],
...
</xsl:text><xsl:variable name="FGDC_Mandatory.itemCounts.d1e980" as="xs:integer+"><xsl:sequence
                select="count(/eml:eml/dataset/metadataProvider)"/></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"/><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemCounts.d1e980)"/><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
{</xsl:text><xsl:text>"path":"/eml:eml/dataset/metadataProvider",</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'exists'"/><xsl:text>":"</xsl:text><xsl:value-of
        ...
        <xsl:text>{
</xsl:text><xsl:text>"name":"Resource Cost or Fees",</xsl:text><xsl:text>"exists":"-1",</xsl:text><xsl:text>"count":"-1",</xsl:text><xsl:text>"description":"Cost associated with access to the resource"</xsl:text><xsl:text>}</xsl:text>, <xsl:text>{
...
{</xsl:text><xsl:text>"title":"FGDC for Data Discovery - Mandatory if Applicable",</xsl:text><xsl:text>"code":"FGDC_MandatoryIfApplicable",</xsl:text><xsl:text>"description":"The FGDC Content Standard for Digital Geospatial Metadata includes many fields related to data understanding. These are generally labeled 'Mandatory if Applicable'. In the graphical representation of the standard, these are green fields included in yellow or green sections.",</xsl:text><xsl:text>"maximum":"20",</xsl:text><xsl:variable
            name="FGDC_MandatoryIfApplicable.itemExists" as="xs:integer+">0</xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'existTotal'"/><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_MandatoryIfApplicable.itemExists)"/><xsl:text>",
</xsl:text><xsl:variable name="FGDC_MandatoryIfApplicable.itemCounts" as="xs:integer+">0</xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'countTotal'"/><xsl:text>":"</xsl:text><xsl:value-of
            select="sum($FGDC_MandatoryIfApplicable.itemCounts)"/><xsl:text>",
</xsl:text><xsl:text>
"items" : [
</xsl:text><xsl:text>{
        ...
        <xsl:text>{
</xsl:text><xsl:text>"name":"Source Citation Abbreviation",</xsl:text><xsl:text>"exists":"-1",</xsl:text><xsl:text>"count":"-1",</xsl:text><xsl:text>"description":"Short-form alias for the source citation."</xsl:text><xsl:text>}</xsl:text>, <xsl:text>{
        ...
        <xsl:text>{
</xsl:text><xsl:text>"name":"Source Used",</xsl:text><xsl:text>"exists":"-1",</xsl:text><xsl:text>"count":"-1",</xsl:text><xsl:text>"description":"The source used in the processing step."</xsl:text><xsl:text>}</xsl:text>, <xsl:text>{
        ...
        <xsl:text>{
</xsl:text><xsl:text>"name":"Source Produced",</xsl:text><xsl:text>"exists":"-1",</xsl:text><xsl:text>"count":"-1",</xsl:text><xsl:text>"description":"The source produced from the process step."</xsl:text><xsl:text>}</xsl:text>, <xsl:text>{
