...
{</xsl:text><xsl:text>"title":"Attribute Convention for Data Discovery - Highly Recommended",</xsl:text><xsl:text>"code":"ACDD_highlyRecommended",</xsl:text><xsl:text>"description":"These attributes are highly recommended by the Attribute Convention for Data Discovery",</xsl:text><xsl:text>"maximum":"3",</xsl:text><xsl:variable name="ACDD_highlyRecommended.itemExists" as="xs:integer+"><xsl:sequence select="if(exists(/onedcx:metadata/onedcx:simpleDc/dcterms:title)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/onedcx:metadata/onedcx:simpleDc/dcterms:description | /onedcx:metadata/onedcx:dcTerms/dcterms:abstract)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/onedcx:metadata/onedcx:simpleDc/dcterms:subject)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'existTotal'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_highlyRecommended.itemExists)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="ACDD_highlyRecommended.itemCounts" as="xs:integer+"><xsl:sequence select="count(/onedcx:metadata/onedcx:simpleDc/dcterms:title)"></xsl:sequence><xsl:sequence select="count(/onedcx:metadata/onedcx:simpleDc/dcterms:description) + count(/onedcx:metadata/onedcx:dcTerms/dcterms:abstract)"></xsl:sequence><xsl:sequence select="count(/onedcx:metadata/onedcx:simpleDc/dcterms:subject)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'countTotal'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_highlyRecommended.itemCounts)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"items" : [
</xsl:text><xsl:text>{
</xsl:text><xsl:text>"name":"Resource Title",</xsl:text><xsl:variable name="ACDD_highlyRecommended.itemExists.d1e314" as="xs:integer+"><xsl:sequence select="if(exists(/onedcx:metadata/onedcx:simpleDc/dcterms:title)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_highlyRecommended.itemExists.d1e314)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="ACDD_highlyRecommended.itemCounts.d1e314" as="xs:integer+"><xsl:sequence select="count(/onedcx:metadata/onedcx:simpleDc/dcterms:title)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_highlyRecommended.itemCounts.d1e314)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Abstract",</xsl:text><xsl:variable name="ACDD_highlyRecommended.itemExists.d1e573" as="xs:integer+"><xsl:sequence select="if(exists(/onedcx:metadata/onedcx:simpleDc/dcterms:description | /onedcx:metadata/onedcx:dcTerms/dcterms:abstract)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_highlyRecommended.itemExists.d1e573)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="ACDD_highlyRecommended.itemCounts.d1e573" as="xs:integer+"><xsl:sequence select="count(/onedcx:metadata/onedcx:simpleDc/dcterms:description | /onedcx:metadata/onedcx:dcTerms/dcterms:abstract)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_highlyRecommended.itemCounts.d1e573)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Keyword",</xsl:text><xsl:variable name="ACDD_highlyRecommended.itemExists.d1e12800" as="xs:integer+"><xsl:sequence select="if(exists(/onedcx:metadata/onedcx:simpleDc/dcterms:subject)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_highlyRecommended.itemExists.d1e12800)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="ACDD_highlyRecommended.itemCounts.d1e12800" as="xs:integer+"><xsl:sequence select="count(/onedcx:metadata/onedcx:simpleDc/dcterms:subject)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_highlyRecommended.itemCounts.d1e12800)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
{</xsl:text><xsl:text>"title":"Attribute Convention for Data Discovery - Recommended",</xsl:text><xsl:text>"code":"ACDD_recommended",</xsl:text><xsl:text>"description":"These attributes are recommended by the Attribute Convention for Data Discovery",</xsl:text><xsl:text>"maximum":"27",</xsl:text><xsl:variable name="ACDD_recommended.itemExists" as="xs:integer+"><xsl:sequence select="if(exists(/onedcx:metadata/onedcx:simpleDc/dcterms:identifier)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/onedcx:metadata/onedcx:dcTerms/dcterms:provenance)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/onedcx:metadata/onedcx:dcTerms/dcterms:modified)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/onedcx:metadata/onedcx:dcTerms/dcterms:temporal)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'existTotal'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_recommended.itemExists)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="ACDD_recommended.itemCounts" as="xs:integer+"><xsl:sequence select="count(/onedcx:metadata/onedcx:simpleDc/dcterms:identifier)"></xsl:sequence><xsl:sequence select="count(/onedcx:metadata/onedcx:dcTerms/dcterms:provenance)"></xsl:sequence><xsl:sequence select="count(/onedcx:metadata/onedcx:dcTerms/dcterms:modified)"></xsl:sequence><xsl:sequence select="count(/onedcx:metadata/onedcx:dcTerms/dcterms:temporal)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'countTotal'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_recommended.itemCounts)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"items" : [
</xsl:text><xsl:text>{
</xsl:text><xsl:text>"name":"Resource Identifier",</xsl:text><xsl:variable name="ACDD_recommended.itemExists.d1e2746" as="xs:integer+"><xsl:sequence select="if(exists(/onedcx:metadata/onedcx:simpleDc/dcterms:identifier)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_recommended.itemExists.d1e2746)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="ACDD_recommended.itemCounts.d1e2746" as="xs:integer+"><xsl:sequence select="count(/onedcx:metadata/onedcx:simpleDc/dcterms:identifier)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_recommended.itemCounts.d1e2746)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Lineage Statement",</xsl:text><xsl:variable name="ACDD_recommended.itemExists.d1e3080" as="xs:integer+"><xsl:sequence select="if(exists(/onedcx:metadata/onedcx:dcTerms/dcterms:provenance)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_recommended.itemExists.d1e3080)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="ACDD_recommended.itemCounts.d1e3080" as="xs:integer+"><xsl:sequence select="count(/onedcx:metadata/onedcx:dcTerms/dcterms:provenance)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_recommended.itemCounts.d1e3080)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
{</xsl:text><xsl:text>"path":"/onedcx:metadata/onedcx:dcTerms/dcterms:provenance",</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="if(exists(/onedcx:metadata/onedcx:dcTerms/dcterms:provenance)) then 1 else 0"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>"</xsl:text><xsl:text>:</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="count(/onedcx:metadata/onedcx:dcTerms/dcterms:provenance)"></xsl:value-of><xsl:text>"
</xsl:text><xsl:text>}</xsl:text><xsl:text>],
</xsl:text><xsl:text>"description":"Information and references for sources and processes that were used to create the dataset and an audit trail for modifications to the original data."</xsl:text><xsl:text>}</xsl:text>,
<xsl:text>{
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Resource Creation/Revision Date",</xsl:text><xsl:variable name="ACDD_recommended.itemExists.d1e447" as="xs:integer+"><xsl:sequence select="if(exists(/onedcx:metadata/onedcx:dcTerms/dcterms:modified)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_recommended.itemExists.d1e447)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="ACDD_recommended.itemCounts.d1e447" as="xs:integer+"><xsl:sequence select="count(/onedcx:metadata/onedcx:dcTerms/dcterms:modified)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_recommended.itemCounts.d1e447)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Southernmost Latitude",</xsl:text><xsl:text>"exists":"-1",</xsl:text><xsl:text>"count":"-1",</xsl:text><xsl:text>"note":"OGC-SOS offering lists may not include the entire dataset. A gml:id attribute can be used to identify the bounding offering.",</xsl:text><xsl:text>"description":"The southernmost latitude of the bounding rectangle."</xsl:text><xsl:text>}</xsl:text>,
<xsl:text>{
</xsl:text><xsl:text>"name":"Northernmost Latitude",</xsl:text><xsl:text>"exists":"-1",</xsl:text><xsl:text>"count":"-1",</xsl:text><xsl:text>"note":"OGC-SOS offering lists may not include the entire dataset. A gml:id attribute (e.g. gml:id=network-all) can be used to identify the bounding offering.",</xsl:text><xsl:text>"description":"The northernmost latitude of the bounding rectangle."</xsl:text><xsl:text>}</xsl:text>,
<xsl:text>{
</xsl:text><xsl:text>"name":"Westernmost Longitude",</xsl:text><xsl:text>"exists":"-1",</xsl:text><xsl:text>"count":"-1",</xsl:text><xsl:text>"note":"OGC-SOS offering lists may not include the entire dataset. A gml:id attribute can be used to identify the bounding offering.",</xsl:text><xsl:text>"description":"The westernmost longitude of the bounding rectangle."</xsl:text><xsl:text>}</xsl:text>,
<xsl:text>{
</xsl:text><xsl:text>"name":"Easternmost Longitude",</xsl:text><xsl:text>"exists":"-1",</xsl:text><xsl:text>"count":"-1",</xsl:text><xsl:text>"note":"OGC-SOS offering lists may not include the entire dataset. A gml:id attribute can be used to identify the bounding offering.",</xsl:text><xsl:text>"description":"The easternmost longitude of the bounding rectangle."</xsl:text><xsl:text>}</xsl:text>,
<xsl:text>{
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Temporal Extent",</xsl:text><xsl:variable name="ACDD_recommended.itemExists.d1e6497" as="xs:integer+"><xsl:sequence select="if(exists(/onedcx:metadata/onedcx:dcTerms/dcterms:temporal)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_recommended.itemExists.d1e6497)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="ACDD_recommended.itemCounts.d1e6497" as="xs:integer+"><xsl:sequence select="count(/onedcx:metadata/onedcx:dcTerms/dcterms:temporal)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_recommended.itemCounts.d1e6497)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
{</xsl:text><xsl:text>"title":"Attribute Convention for Data Discovery - Suggested",</xsl:text><xsl:text>"code":"ACDD_suggested",</xsl:text><xsl:text>"description":"These attributes are suggested by the Attribute Convention for Data Discovery",</xsl:text><xsl:text>"maximum":"5",</xsl:text><xsl:variable name="ACDD_suggested.itemExists" as="xs:integer+"><xsl:sequence select="if(exists(/onedcx:metadata/onedcx:simpleDc/dcterms:contributor)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/onedcx:metadata/onedcx:simpleDc/dcterms:publisher)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'existTotal'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_suggested.itemExists)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="ACDD_suggested.itemCounts" as="xs:integer+"><xsl:sequence select="count(/onedcx:metadata/onedcx:simpleDc/dcterms:contributor)"></xsl:sequence><xsl:sequence select="count(/onedcx:metadata/onedcx:simpleDc/dcterms:publisher)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'countTotal'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_suggested.itemCounts)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"items" : [
</xsl:text><xsl:text>{
</xsl:text><xsl:text>"name":"Contributor Name",</xsl:text><xsl:variable name="ACDD_suggested.itemExists.d1e4650" as="xs:integer+"><xsl:sequence select="if(exists(/onedcx:metadata/onedcx:simpleDc/dcterms:contributor)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_suggested.itemExists.d1e4650)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="ACDD_suggested.itemCounts.d1e4650" as="xs:integer+"><xsl:sequence select="count(/onedcx:metadata/onedcx:simpleDc/dcterms:contributor)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_suggested.itemCounts.d1e4650)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Publisher",</xsl:text><xsl:variable name="ACDD_suggested.itemExists.d1e2221" as="xs:integer+"><xsl:sequence select="if(exists(/onedcx:metadata/onedcx:simpleDc/dcterms:publisher)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_suggested.itemExists.d1e2221)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="ACDD_suggested.itemCounts.d1e2221" as="xs:integer+"><xsl:sequence select="count(/onedcx:metadata/onedcx:simpleDc/dcterms:publisher)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_suggested.itemCounts.d1e2221)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
