...
{</xsl:text><xsl:text>"title":"Attribute Convention for Data Discovery - Highly Recommended",</xsl:text><xsl:text>"code":"ACDD_highlyRecommended",</xsl:text><xsl:text>"description":"These attributes are highly recommended by the Attribute Convention for Data Discovery",</xsl:text><xsl:text>"maximum":"3",</xsl:text><xsl:variable name="ACDD_highlyRecommended.itemExists" as="xs:integer+"><xsl:sequence select="if(exists(/metadata/idinfo/citation/citeinfo/title)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/metadata/idinfo/descript/abstract)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/metadata/idinfo/keywords/theme/themekey | /metadata/mercury/Parameter_Description/Sensor | /metadata/mercury/Parameter_Description/Source | /metadata/mercury/Parameter_Description/Term | /metadata/mercury/Parameter_Description/Topic)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'existTotal'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_highlyRecommended.itemExists)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="ACDD_highlyRecommended.itemCounts" as="xs:integer+"><xsl:sequence select="count(/metadata/idinfo/citation/citeinfo/title)"></xsl:sequence><xsl:sequence select="count(/metadata/idinfo/descript/abstract)"></xsl:sequence><xsl:sequence select="count(/metadata/idinfo/keywords/theme/themekey) + count(/metadata/mercury/Parameter_Description/Sensor) + count(/metadata/mercury/Parameter_Description/Source) + count(/metadata/mercury/Parameter_Description/Term) + count(/metadata/mercury/Parameter_Description/Topic)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'countTotal'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_highlyRecommended.itemCounts)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"items" : [
</xsl:text><xsl:text>{
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Keyword",</xsl:text><xsl:variable name="ACDD_highlyRecommended.itemExists.d1e12800" as="xs:integer+"><xsl:sequence select="if(exists(/metadata/idinfo/keywords/theme/themekey | /metadata/mercury/Parameter_Description/Sensor | /metadata/mercury/Parameter_Description/Source | /metadata/mercury/Parameter_Description/Term | /metadata/mercury/Parameter_Description/Topic)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_highlyRecommended.itemExists.d1e12800)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="ACDD_highlyRecommended.itemCounts.d1e12800" as="xs:integer+"><xsl:sequence select="count(/metadata/idinfo/keywords/theme/themekey | /metadata/mercury/Parameter_Description/Sensor | /metadata/mercury/Parameter_Description/Source | /metadata/mercury/Parameter_Description/Term | /metadata/mercury/Parameter_Description/Topic)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_highlyRecommended.itemCounts.d1e12800)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
{</xsl:text><xsl:text>"title":"Attribute Convention for Data Discovery - Recommended",</xsl:text><xsl:text>"code":"ACDD_recommended",</xsl:text><xsl:text>"description":"These attributes are recommended by the Attribute Convention for Data Discovery",</xsl:text><xsl:text>"maximum":"27",</xsl:text><xsl:variable name="ACDD_recommended.itemExists" as="xs:integer+"><xsl:sequence select="if(exists(/metadata/mercury/File_ID)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/metadata/idinfo/keywords/theme/themekt)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/metadata/idinfo/citation/citeinfo/pubdate)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/metadata/idinfo/ptcontac)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/metadata/idinfo/citation/citeinfo/origin)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/metadata/mercury/Project)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/metadata/idinfo/spdom/bounding)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/metadata/idinfo/spdom/bounding/southbc)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/metadata/idinfo/spdom/bounding/northbc)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/metadata/idinfo/spdom/bounding/westbc | /metadata/mercury/Site_Information/Westernmost_Longitude)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/metadata/idinfo/spdom/bounding/eastbc | /metadata/mercury/Site_Information/Easternmost_Longitude)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/metadata/idinfo/timeperd/timeinfo/rngdates | /metadata/mercury/begdate and /metadata/mercury/enddate)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'existTotal'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_recommended.itemExists)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="ACDD_recommended.itemCounts" as="xs:integer+"><xsl:sequence select="count(/metadata/mercury/File_ID)"></xsl:sequence><xsl:sequence select="count(/metadata/idinfo/keywords/theme/themekt)"></xsl:sequence><xsl:sequence select="count(/metadata/idinfo/citation/citeinfo/pubdate)"></xsl:sequence><xsl:sequence select="count(/metadata/idinfo/ptcontac)"></xsl:sequence><xsl:sequence select="count(/metadata/idinfo/citation/citeinfo/origin)"></xsl:sequence><xsl:sequence select="count(/metadata/mercury/Project)"></xsl:sequence><xsl:sequence select="count(/metadata/idinfo/spdom/bounding)"></xsl:sequence><xsl:sequence select="count(/metadata/idinfo/spdom/bounding/southbc)"></xsl:sequence><xsl:sequence select="count(/metadata/idinfo/spdom/bounding/northbc)"></xsl:sequence><xsl:sequence select="count(/metadata/idinfo/spdom/bounding/westbc) + count(/metadata/mercury/Site_Information/Westernmost_Longitude)"></xsl:sequence><xsl:sequence select="count(/metadata/idinfo/spdom/bounding/eastbc) + count(/metadata/mercury/Site_Information/Easternmost_Longitude)"></xsl:sequence><xsl:sequence select="count(/metadata/idinfo/timeperd/timeinfo/rngdates) + count(/metadata/mercury/begdate and /metadata/mercury/enddate)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'countTotal'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_recommended.itemCounts)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"items" : [
</xsl:text><xsl:text>{
</xsl:text><xsl:text>"name":"Resource Identifier",</xsl:text><xsl:variable name="ACDD_recommended.itemExists.d1e2746" as="xs:integer+"><xsl:sequence select="if(exists(/metadata/mercury/File_ID)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_recommended.itemExists.d1e2746)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="ACDD_recommended.itemCounts.d1e2746" as="xs:integer+"><xsl:sequence select="count(/metadata/mercury/File_ID)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_recommended.itemCounts.d1e2746)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Project Name",</xsl:text><xsl:variable name="ACDD_recommended.itemExists.d1e9872" as="xs:integer+"><xsl:sequence select="if(exists(/metadata/mercury/Project)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_recommended.itemExists.d1e9872)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="ACDD_recommended.itemCounts.d1e9872" as="xs:integer+"><xsl:sequence select="count(/metadata/mercury/Project)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_recommended.itemCounts.d1e9872)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Westernmost Longitude",</xsl:text><xsl:variable name="ACDD_recommended.itemExists.d1e3334" as="xs:integer+"><xsl:sequence select="if(exists(/metadata/idinfo/spdom/bounding/westbc | /metadata/mercury/Site_Information/Westernmost_Longitude)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_recommended.itemExists.d1e3334)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="ACDD_recommended.itemCounts.d1e3334" as="xs:integer+"><xsl:sequence select="count(/metadata/idinfo/spdom/bounding/westbc | /metadata/mercury/Site_Information/Westernmost_Longitude)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_recommended.itemCounts.d1e3334)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
{</xsl:text><xsl:text>"path":"/metadata/mercury/Site_Information/Westernmost_Longitude",</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="if(exists(/metadata/mercury/Site_Information/Westernmost_Longitude)) then 1 else 0"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>"</xsl:text><xsl:text>:</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="count(/metadata/mercury/Site_Information/Westernmost_Longitude)"></xsl:value-of><xsl:text>"
</xsl:text><xsl:text>}</xsl:text><xsl:text>],
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Easternmost Longitude",</xsl:text><xsl:variable name="ACDD_recommended.itemExists.d1e3406" as="xs:integer+"><xsl:sequence select="if(exists(/metadata/idinfo/spdom/bounding/eastbc | /metadata/mercury/Site_Information/Easternmost_Longitude)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_recommended.itemExists.d1e3406)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="ACDD_recommended.itemCounts.d1e3406" as="xs:integer+"><xsl:sequence select="count(/metadata/idinfo/spdom/bounding/eastbc | /metadata/mercury/Site_Information/Easternmost_Longitude)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_recommended.itemCounts.d1e3406)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
{</xsl:text><xsl:text>"path":"/metadata/mercury/Site_Information/Easternmost_Longitude",</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="if(exists(/metadata/mercury/Site_Information/Easternmost_Longitude)) then 1 else 0"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>"</xsl:text><xsl:text>:</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="count(/metadata/mercury/Site_Information/Easternmost_Longitude)"></xsl:value-of><xsl:text>"
</xsl:text><xsl:text>}</xsl:text><xsl:text>],
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Temporal Extent",</xsl:text><xsl:variable name="ACDD_recommended.itemExists.d1e6497" as="xs:integer+"><xsl:sequence select="if(exists(/metadata/idinfo/timeperd/timeinfo/rngdates | /metadata/mercury/begdate and /metadata/mercury/enddate)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_recommended.itemExists.d1e6497)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="ACDD_recommended.itemCounts.d1e6497" as="xs:integer+"><xsl:sequence select="count(/metadata/idinfo/timeperd/timeinfo/rngdates | /metadata/mercury/begdate and /metadata/mercury/enddate)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_recommended.itemCounts.d1e6497)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
{</xsl:text><xsl:text>"title":"Attribute Convention for Data Discovery - Suggested",</xsl:text><xsl:text>"code":"ACDD_suggested",</xsl:text><xsl:text>"description":"These attributes are suggested by the Attribute Convention for Data Discovery",</xsl:text><xsl:text>"maximum":"5",</xsl:text><xsl:variable name="ACDD_suggested.itemExists" as="xs:integer+">0</xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'existTotal'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_suggested.itemExists)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="ACDD_suggested.itemCounts" as="xs:integer+">0</xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'countTotal'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_suggested.itemCounts)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"items" : [
</xsl:text><xsl:text>{
