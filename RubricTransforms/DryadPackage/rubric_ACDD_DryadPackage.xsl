...
{</xsl:text><xsl:text>"title":"Attribute Convention for Data Discovery - Highly Recommended",</xsl:text><xsl:text>"code":"ACDD_highlyRecommended",</xsl:text><xsl:text>"description":"These attributes are highly recommended by the Attribute Convention for Data Discovery",</xsl:text><xsl:text>"maximum":"3",</xsl:text><xsl:variable name="ACDD_highlyRecommended.itemExists" as="xs:integer+"><xsl:sequence select="if(exists(/dryad:DryadDataPackage/dcterms:title)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/dryad:DryadDataPackage/dcterms:description)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/dryad:DryadDataPackage/dcterms:subject)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'existTotal'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_highlyRecommended.itemExists)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="ACDD_highlyRecommended.itemCounts" as="xs:integer+"><xsl:sequence select="count(/dryad:DryadDataPackage/dcterms:title)"></xsl:sequence><xsl:sequence select="count(/dryad:DryadDataPackage/dcterms:description)"></xsl:sequence><xsl:sequence select="count(/dryad:DryadDataPackage/dcterms:subject)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'countTotal'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_highlyRecommended.itemCounts)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"items" : [
</xsl:text><xsl:text>{
</xsl:text><xsl:text>"name":"Resource Title",</xsl:text><xsl:variable name="ACDD_highlyRecommended.itemExists.d1e314" as="xs:integer+"><xsl:sequence select="if(exists(/dryad:DryadDataPackage/dcterms:title)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_highlyRecommended.itemExists.d1e314)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="ACDD_highlyRecommended.itemCounts.d1e314" as="xs:integer+"><xsl:sequence select="count(/dryad:DryadDataPackage/dcterms:title)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_highlyRecommended.itemCounts.d1e314)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Abstract",</xsl:text><xsl:variable name="ACDD_highlyRecommended.itemExists.d1e573" as="xs:integer+"><xsl:sequence select="if(exists(/dryad:DryadDataPackage/dcterms:description)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_highlyRecommended.itemExists.d1e573)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="ACDD_highlyRecommended.itemCounts.d1e573" as="xs:integer+"><xsl:sequence select="count(/dryad:DryadDataPackage/dcterms:description)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_highlyRecommended.itemCounts.d1e573)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Keyword",</xsl:text><xsl:variable name="ACDD_highlyRecommended.itemExists.d1e12800" as="xs:integer+"><xsl:sequence select="if(exists(/dryad:DryadDataPackage/dcterms:subject)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_highlyRecommended.itemExists.d1e12800)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="ACDD_highlyRecommended.itemCounts.d1e12800" as="xs:integer+"><xsl:sequence select="count(/dryad:DryadDataPackage/dcterms:subject)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_highlyRecommended.itemCounts.d1e12800)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
{</xsl:text><xsl:text>"title":"Attribute Convention for Data Discovery - Recommended",</xsl:text><xsl:text>"code":"ACDD_recommended",</xsl:text><xsl:text>"description":"These attributes are recommended by the Attribute Convention for Data Discovery",</xsl:text><xsl:text>"maximum":"27",</xsl:text><xsl:variable name="ACDD_recommended.itemExists" as="xs:integer+"><xsl:sequence select="if(exists(/dryad:DryadDataPackage/dcterms:identifier)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/dryad:DryadDataPackage/dcterms:dateSubmitted | /dryad:DryadDataPackage/dcterms:available)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/dryad:DryadDataPackage/dcterms:temporal)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'existTotal'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_recommended.itemExists)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="ACDD_recommended.itemCounts" as="xs:integer+"><xsl:sequence select="count(/dryad:DryadDataPackage/dcterms:identifier)"></xsl:sequence><xsl:sequence select="count(/dryad:DryadDataPackage/dcterms:dateSubmitted) + count(/dryad:DryadDataPackage/dcterms:available)"></xsl:sequence><xsl:sequence select="count(/dryad:DryadDataPackage/dcterms:temporal)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'countTotal'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_recommended.itemCounts)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"items" : [
</xsl:text><xsl:text>{
</xsl:text><xsl:text>"name":"Resource Identifier",</xsl:text><xsl:variable name="ACDD_recommended.itemExists.d1e2746" as="xs:integer+"><xsl:sequence select="if(exists(/dryad:DryadDataPackage/dcterms:identifier)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_recommended.itemExists.d1e2746)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="ACDD_recommended.itemCounts.d1e2746" as="xs:integer+"><xsl:sequence select="count(/dryad:DryadDataPackage/dcterms:identifier)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_recommended.itemCounts.d1e2746)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Resource Creation/Revision Date",</xsl:text><xsl:variable name="ACDD_recommended.itemExists.d1e447" as="xs:integer+"><xsl:sequence select="if(exists(/dryad:DryadDataPackage/dcterms:dateSubmitted | /dryad:DryadDataPackage/dcterms:available)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_recommended.itemExists.d1e447)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="ACDD_recommended.itemCounts.d1e447" as="xs:integer+"><xsl:sequence select="count(/dryad:DryadDataPackage/dcterms:dateSubmitted | /dryad:DryadDataPackage/dcterms:available)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_recommended.itemCounts.d1e447)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Temporal Extent",</xsl:text><xsl:variable name="ACDD_recommended.itemExists.d1e6497" as="xs:integer+"><xsl:sequence select="if(exists(/dryad:DryadDataPackage/dcterms:temporal)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_recommended.itemExists.d1e6497)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="ACDD_recommended.itemCounts.d1e6497" as="xs:integer+"><xsl:sequence select="count(/dryad:DryadDataPackage/dcterms:temporal)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($ACDD_recommended.itemCounts.d1e6497)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
