...
{</xsl:text><xsl:text>"title":"FGDC for Data Discovery - Mandatory",</xsl:text><xsl:text>"code":"FGDC_Mandatory",</xsl:text><xsl:text>"description":"The FGDC Content Standard for Digital Geospatial Metadata includes fields in the Identification Information and Metadata Reference Sections that are mandatory for data discovery. In the graphical representation of the standard, these are yellow fields included in yellow sections.",</xsl:text><xsl:text>"maximum":"20",</xsl:text><xsl:variable name="FGDC_Mandatory.itemExists" as="xs:integer+"><xsl:sequence select="if(exists(/*/echo:ShortName | /*/echo:LongName | /*/echo:DataSetId)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/*/echo:ProcessingCenter)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/*/echo:InsertTime)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/*/echo:Description)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/*/SuggestedUsage)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/*/Temporal//*)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/*/echo:Spatial/echo:HorizontalSpatialDomain/echo:Geometry/echo:BoundingRectangle//*)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/*/echo:RestrictionFlag | /*/echo:RestrictionComment | /*/echo:Visible)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/*/echo:RestrictionFlag | /*/echo:RestrictionComment)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/*/echo:ScienceKeywords/echo:ScienceKeyword/echo:CategoryKeyword | /*/echo:ScienceKeywords/echo:ScienceKeyword/echo:TopicKeyword | /*/echo:ScienceKeywords/echo:ScienceKeyword/echo:TermKeyword | /*/echo:ScienceKeywords/echo:ScienceKeyword/echo:VariableLevel1Keyword/echo:Value | /*/echo:ScienceKeywords/echo:ScienceKeyword/echo:VariableLevel2Keyword/echo:Value | /*/echo:ScienceKeywords/echo:ScienceKeyword/echo:VariableLevel3Keyword | /*/echo:ScienceKeywords/echo:ScienceKeyword/echo:DetailedVariableKeyword)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/*/echo:ArchiveCenter | /*/Contacts/Contact[contains(Role,'Data Manager')] | /*/Contacts/Contact[contains(Role,'DATA CENTER CONTACT')] | /*/Contacts/Contact[contains(Role,'Archive')] | /*/Contacts/Contact[contains(Role,'Distributor')] | /*/Contacts/Contact[contains(Role,'GHRC USER SERVICES')] | /*/Contacts/Contact[contains(Role,'User Services')])) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/*/echo:ArchiveCenter | /*/Contacts/Contact[contains(Role,'DIF AUTHOR')])) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/*/echo:Orderable)) then 1 else 0"></xsl:sequence><xsl:sequence select="if(exists(/*/echo:Price)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'existTotal'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemExists)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="FGDC_Mandatory.itemCounts" as="xs:integer+"><xsl:sequence select="count(/*/echo:ShortName | /*/echo:LongName) + count(/*/echo:DataSetId)"></xsl:sequence><xsl:sequence select="count(/*/echo:ProcessingCenter)"></xsl:sequence><xsl:sequence select="count(/*/echo:InsertTime)"></xsl:sequence><xsl:sequence select="count(/*/echo:Description)"></xsl:sequence><xsl:sequence select="count(/*/SuggestedUsage)"></xsl:sequence><xsl:sequence select="count(/*/Temporal//*)"></xsl:sequence><xsl:sequence select="count(/*/echo:Spatial/echo:HorizontalSpatialDomain/echo:Geometry/echo:BoundingRectangle//*)"></xsl:sequence><xsl:sequence select="count(/*/echo:RestrictionFlag) + count(/*/echo:RestrictionComment) + count(/*/echo:Visible)"></xsl:sequence><xsl:sequence select="count(/*/echo:RestrictionFlag) + count(/*/echo:RestrictionComment)"></xsl:sequence><xsl:sequence select="count(/*/echo:ScienceKeywords/echo:ScienceKeyword/echo:CategoryKeyword) + count(/*/echo:ScienceKeywords/echo:ScienceKeyword/echo:TopicKeyword) + count(/*/echo:ScienceKeywords/echo:ScienceKeyword/echo:TermKeyword) + count(/*/echo:ScienceKeywords/echo:ScienceKeyword/echo:VariableLevel1Keyword/echo:Value) + count(/*/echo:ScienceKeywords/echo:ScienceKeyword/echo:VariableLevel2Keyword/echo:Value) + count(/*/echo:ScienceKeywords/echo:ScienceKeyword/echo:VariableLevel3Keyword) + count(/*/echo:ScienceKeywords/echo:ScienceKeyword/echo:DetailedVariableKeyword)"></xsl:sequence><xsl:sequence select="count(/*/echo:ArchiveCenter) + count(/*/Contacts/Contact[contains(Role,'Data Manager')]) + count(/*/Contacts/Contact[contains(Role,'DATA CENTER CONTACT')]) + count(/*/Contacts/Contact[contains(Role,'Archive')]) + count(/*/Contacts/Contact[contains(Role,'Distributor')]) + count(/*/Contacts/Contact[contains(Role,'GHRC USER SERVICES')]) + count(/*/Contacts/Contact[contains(Role,'User Services')])"></xsl:sequence><xsl:sequence select="count(/*/echo:ArchiveCenter) + count(/*/Contacts/Contact[contains(Role,'DIF AUTHOR')])"></xsl:sequence><xsl:sequence select="count(/*/echo:Orderable)"></xsl:sequence><xsl:sequence select="count(/*/echo:Price)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'countTotal'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemCounts)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"items" : [
</xsl:text><xsl:text>{
</xsl:text><xsl:text>"name":"Resource Title",</xsl:text><xsl:variable name="FGDC_Mandatory.itemExists.d1e287" as="xs:integer+"><xsl:sequence select="if(exists(/*/echo:ShortName | /*/echo:LongName | /*/echo:DataSetId)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemExists.d1e287)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="FGDC_Mandatory.itemCounts.d1e287" as="xs:integer+"><xsl:sequence select="count(/*/echo:ShortName | /*/echo:LongName | /*/echo:DataSetId)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemCounts.d1e287)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Originating Organization",</xsl:text><xsl:variable name="FGDC_Mandatory.itemExists.d1e4067" as="xs:integer+"><xsl:sequence select="if(exists(/*/echo:ProcessingCenter)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemExists.d1e4067)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="FGDC_Mandatory.itemCounts.d1e4067" as="xs:integer+"><xsl:sequence select="count(/*/echo:ProcessingCenter)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemCounts.d1e4067)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
{</xsl:text><xsl:text>"path":"/*/echo:ProcessingCenter",</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="if(exists(/*/echo:ProcessingCenter)) then 1 else 0"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>"</xsl:text><xsl:text>:</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="count(/*/echo:ProcessingCenter)"></xsl:value-of><xsl:text>"
</xsl:text><xsl:text>}</xsl:text><xsl:text>],
</xsl:text><xsl:text>"description":"The organization responsible for creating the resource"</xsl:text><xsl:text>}</xsl:text>,
<xsl:text>{
</xsl:text><xsl:text>"name":"Publication Date",</xsl:text><xsl:variable name="FGDC_Mandatory.itemExists.d1e2086" as="xs:integer+"><xsl:sequence select="if(exists(/*/echo:InsertTime)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemExists.d1e2086)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="FGDC_Mandatory.itemCounts.d1e2086" as="xs:integer+"><xsl:sequence select="count(/*/echo:InsertTime)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemCounts.d1e2086)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Abstract",</xsl:text><xsl:variable name="FGDC_Mandatory.itemExists.d1e543" as="xs:integer+"><xsl:sequence select="if(exists(/*/echo:Description)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemExists.d1e543)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="FGDC_Mandatory.itemCounts.d1e543" as="xs:integer+"><xsl:sequence select="count(/*/echo:Description)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemCounts.d1e543)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Purpose",</xsl:text><xsl:variable name="FGDC_Mandatory.itemExists.d1e2981" as="xs:integer+"><xsl:sequence select="if(exists(/*/SuggestedUsage)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemExists.d1e2981)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="FGDC_Mandatory.itemCounts.d1e2981" as="xs:integer+"><xsl:sequence select="count(/*/SuggestedUsage)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemCounts.d1e2981)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Temporal Extent",</xsl:text><xsl:variable name="FGDC_Mandatory.itemExists.d1e6449" as="xs:integer+"><xsl:sequence select="if(exists(/*/Temporal//*)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemExists.d1e6449)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="FGDC_Mandatory.itemCounts.d1e6449" as="xs:integer+"><xsl:sequence select="count(/*/Temporal//*)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemCounts.d1e6449)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Bounding Box",</xsl:text><xsl:variable name="FGDC_Mandatory.itemExists.d1e4470" as="xs:integer+"><xsl:sequence select="if(exists(/*/echo:Spatial/echo:HorizontalSpatialDomain/echo:Geometry/echo:BoundingRectangle//*)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemExists.d1e4470)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="FGDC_Mandatory.itemCounts.d1e4470" as="xs:integer+"><xsl:sequence select="count(/*/echo:Spatial/echo:HorizontalSpatialDomain/echo:Geometry/echo:BoundingRectangle//*)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemCounts.d1e4470)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
{</xsl:text><xsl:text>"path":"/*/echo:Spatial/echo:HorizontalSpatialDomain/echo:Geometry/echo:BoundingRectangle//*",</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="if(exists(/*/echo:Spatial/echo:HorizontalSpatialDomain/echo:Geometry/echo:BoundingRectangle//*)) then 1 else 0"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>"</xsl:text><xsl:text>:</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="count(/*/echo:Spatial/echo:HorizontalSpatialDomain/echo:Geometry/echo:BoundingRectangle//*)"></xsl:value-of><xsl:text>"
</xsl:text><xsl:text>}</xsl:text><xsl:text>],
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Resource Access Constraints",</xsl:text><xsl:variable name="FGDC_Mandatory.itemExists.d1e4993" as="xs:integer+"><xsl:sequence select="if(exists(/*/echo:RestrictionFlag | /*/echo:RestrictionComment | /*/echo:Visible)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemExists.d1e4993)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="FGDC_Mandatory.itemCounts.d1e4993" as="xs:integer+"><xsl:sequence select="count(/*/echo:RestrictionFlag | /*/echo:RestrictionComment | /*/echo:Visible)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemCounts.d1e4993)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Resource Use Constraints",</xsl:text><xsl:variable name="FGDC_Mandatory.itemExists.d1e5065" as="xs:integer+"><xsl:sequence select="if(exists(/*/echo:RestrictionFlag | /*/echo:RestrictionComment)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemExists.d1e5065)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="FGDC_Mandatory.itemCounts.d1e5065" as="xs:integer+"><xsl:sequence select="count(/*/echo:RestrictionFlag | /*/echo:RestrictionComment)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemCounts.d1e5065)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
{</xsl:text><xsl:text>"path":"/*/echo:RestrictionFlag",</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="if(exists(/*/echo:RestrictionFlag)) then 1 else 0"></xsl:value-of><xsl:text>",
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Keyword",</xsl:text><xsl:variable name="FGDC_Mandatory.itemExists.d1e12070" as="xs:integer+"><xsl:sequence select="if(exists(/*/echo:ScienceKeywords/echo:ScienceKeyword/echo:CategoryKeyword | /*/echo:ScienceKeywords/echo:ScienceKeyword/echo:TopicKeyword | /*/echo:ScienceKeywords/echo:ScienceKeyword/echo:TermKeyword | /*/echo:ScienceKeywords/echo:ScienceKeyword/echo:VariableLevel1Keyword/echo:Value | /*/echo:ScienceKeywords/echo:ScienceKeyword/echo:VariableLevel2Keyword/echo:Value | /*/echo:ScienceKeywords/echo:ScienceKeyword/echo:VariableLevel3Keyword | /*/echo:ScienceKeywords/echo:ScienceKeyword/echo:DetailedVariableKeyword)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemExists.d1e12070)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="FGDC_Mandatory.itemCounts.d1e12070" as="xs:integer+"><xsl:sequence select="count(/*/echo:ScienceKeywords/echo:ScienceKeyword/echo:CategoryKeyword | /*/echo:ScienceKeywords/echo:ScienceKeyword/echo:TopicKeyword | /*/echo:ScienceKeywords/echo:ScienceKeyword/echo:TermKeyword | /*/echo:ScienceKeywords/echo:ScienceKeyword/echo:VariableLevel1Keyword/echo:Value | /*/echo:ScienceKeywords/echo:ScienceKeyword/echo:VariableLevel2Keyword/echo:Value | /*/echo:ScienceKeywords/echo:ScienceKeyword/echo:VariableLevel3Keyword | /*/echo:ScienceKeywords/echo:ScienceKeyword/echo:DetailedVariableKeyword)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemCounts.d1e12070)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
{</xsl:text><xsl:text>"path":"/*/echo:ScienceKeywords/echo:ScienceKeyword/echo:CategoryKeyword",</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="if(exists(/*/echo:ScienceKeywords/echo:ScienceKeyword/echo:CategoryKeyword)) then 1 else 0"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>"</xsl:text><xsl:text>:</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="count(/*/echo:ScienceKeywords/echo:ScienceKeyword/echo:CategoryKeyword)"></xsl:value-of><xsl:text>"
</xsl:text><xsl:text>}</xsl:text><xsl:text>,</xsl:text><xsl:text>
{</xsl:text><xsl:text>"path":"/*/echo:ScienceKeywords/echo:ScienceKeyword/echo:TopicKeyword",</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="if(exists(/*/echo:ScienceKeywords/echo:ScienceKeyword/echo:TopicKeyword)) then 1 else 0"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>"</xsl:text><xsl:text>:</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="count(/*/echo:ScienceKeywords/echo:ScienceKeyword/echo:TopicKeyword)"></xsl:value-of><xsl:text>"
</xsl:text><xsl:text>}</xsl:text><xsl:text>,</xsl:text><xsl:text>
{</xsl:text><xsl:text>"path":"/*/echo:ScienceKeywords/echo:ScienceKeyword/echo:TermKeyword",</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="if(exists(/*/echo:ScienceKeywords/echo:ScienceKeyword/echo:TermKeyword)) then 1 else 0"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>"</xsl:text><xsl:text>:</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="count(/*/echo:ScienceKeywords/echo:ScienceKeyword/echo:TermKeyword)"></xsl:value-of><xsl:text>"
</xsl:text><xsl:text>}</xsl:text><xsl:text>,</xsl:text><xsl:text>
{</xsl:text><xsl:text>"path":"/*/echo:ScienceKeywords/echo:ScienceKeyword/echo:VariableLevel1Keyword/echo:Value",</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="if(exists(/*/echo:ScienceKeywords/echo:ScienceKeyword/echo:VariableLevel1Keyword/echo:Value)) then 1 else 0"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>"</xsl:text><xsl:text>:</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="count(/*/echo:ScienceKeywords/echo:ScienceKeyword/echo:VariableLevel1Keyword/echo:Value)"></xsl:value-of><xsl:text>"
</xsl:text><xsl:text>}</xsl:text><xsl:text>,</xsl:text><xsl:text>
{</xsl:text><xsl:text>"path":"/*/echo:ScienceKeywords/echo:ScienceKeyword/echo:VariableLevel2Keyword/echo:Value",</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="if(exists(/*/echo:ScienceKeywords/echo:ScienceKeyword/echo:VariableLevel2Keyword/echo:Value)) then 1 else 0"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>"</xsl:text><xsl:text>:</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="count(/*/echo:ScienceKeywords/echo:ScienceKeyword/echo:VariableLevel2Keyword/echo:Value)"></xsl:value-of><xsl:text>"
</xsl:text><xsl:text>}</xsl:text><xsl:text>,</xsl:text><xsl:text>
{</xsl:text><xsl:text>"path":"/*/echo:ScienceKeywords/echo:ScienceKeyword/echo:VariableLevel3Keyword",</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="if(exists(/*/echo:ScienceKeywords/echo:ScienceKeyword/echo:VariableLevel3Keyword)) then 1 else 0"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>"</xsl:text><xsl:text>:</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="count(/*/echo:ScienceKeywords/echo:ScienceKeyword/echo:VariableLevel3Keyword)"></xsl:value-of><xsl:text>"
</xsl:text><xsl:text>}</xsl:text><xsl:text>,</xsl:text><xsl:text>
{</xsl:text><xsl:text>"path":"/*/echo:ScienceKeywords/echo:ScienceKeyword/echo:DetailedVariableKeyword",</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="if(exists(/*/echo:ScienceKeywords/echo:ScienceKeyword/echo:DetailedVariableKeyword)) then 1 else 0"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>"</xsl:text><xsl:text>:</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="count(/*/echo:ScienceKeywords/echo:ScienceKeyword/echo:DetailedVariableKeyword)"></xsl:value-of><xsl:text>"
</xsl:text><xsl:text>}</xsl:text><xsl:text>],
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Distribution Contact",</xsl:text><xsl:variable name="FGDC_Mandatory.itemExists.d1e5389" as="xs:integer+"><xsl:sequence select="if(exists(/*/echo:ArchiveCenter | /*/Contacts/Contact[contains(Role,'Data Manager')] | /*/Contacts/Contact[contains(Role,'DATA CENTER CONTACT')] | /*/Contacts/Contact[contains(Role,'Archive')] | /*/Contacts/Contact[contains(Role,'Distributor')] | /*/Contacts/Contact[contains(Role,'GHRC USER SERVICES')] | /*/Contacts/Contact[contains(Role,'User Services')])) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemExists.d1e5389)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="FGDC_Mandatory.itemCounts.d1e5389" as="xs:integer+"><xsl:sequence select="count(/*/echo:ArchiveCenter | /*/Contacts/Contact[contains(Role,'Data Manager')] | /*/Contacts/Contact[contains(Role,'DATA CENTER CONTACT')] | /*/Contacts/Contact[contains(Role,'Archive')] | /*/Contacts/Contact[contains(Role,'Distributor')] | /*/Contacts/Contact[contains(Role,'GHRC USER SERVICES')] | /*/Contacts/Contact[contains(Role,'User Services')])"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemCounts.d1e5389)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Metadata Contact",</xsl:text><xsl:variable name="FGDC_Mandatory.itemExists.d1e981" as="xs:integer+"><xsl:sequence select="if(exists(/*/echo:ArchiveCenter | /*/Contacts/Contact[contains(Role,'DIF AUTHOR')])) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemExists.d1e981)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="FGDC_Mandatory.itemCounts.d1e981" as="xs:integer+"><xsl:sequence select="count(/*/echo:ArchiveCenter | /*/Contacts/Contact[contains(Role,'DIF AUTHOR')])"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemCounts.d1e981)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
{</xsl:text><xsl:text>"path":"/*/echo:ArchiveCenter",</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="if(exists(/*/echo:ArchiveCenter)) then 1 else 0"></xsl:value-of><xsl:text>",
...
{</xsl:text><xsl:text>"path":"/*/Contacts/Contact[contains(Role,'DIF AUTHOR')]",</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="if(exists(/*/Contacts/Contact[contains(Role,'DIF AUTHOR')])) then 1 else 0"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>"</xsl:text><xsl:text>:</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="count(/*/Contacts/Contact[contains(Role,'DIF AUTHOR')])"></xsl:value-of><xsl:text>"
</xsl:text><xsl:text>}</xsl:text><xsl:text>],
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Ordering Instructions",</xsl:text><xsl:variable name="FGDC_Mandatory.itemExists.d1e5245" as="xs:integer+"><xsl:sequence select="if(exists(/*/echo:Orderable)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemExists.d1e5245)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="FGDC_Mandatory.itemCounts.d1e5245" as="xs:integer+"><xsl:sequence select="count(/*/echo:Orderable)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemCounts.d1e5245)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
{</xsl:text><xsl:text>"path":"/*/echo:Orderable",</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="if(exists(/*/echo:Orderable)) then 1 else 0"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>"</xsl:text><xsl:text>:</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="count(/*/echo:Orderable)"></xsl:value-of><xsl:text>"
</xsl:text><xsl:text>}</xsl:text><xsl:text>],
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Resource Cost or Fees",</xsl:text><xsl:variable name="FGDC_Mandatory.itemExists.d1e5271" as="xs:integer+"><xsl:sequence select="if(exists(/*/echo:Price)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemExists.d1e5271)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="FGDC_Mandatory.itemCounts.d1e5271" as="xs:integer+"><xsl:sequence select="count(/*/echo:Price)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_Mandatory.itemCounts.d1e5271)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
{</xsl:text><xsl:text>"path":"/*/echo:Price",</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="if(exists(/*/echo:Price)) then 1 else 0"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>"</xsl:text><xsl:text>:</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="count(/*/echo:Price)"></xsl:value-of><xsl:text>"
</xsl:text><xsl:text>}</xsl:text><xsl:text>],
...
<xsl:text>{
</xsl:text><xsl:text>"name":"Processor",</xsl:text><xsl:variable name="FGDC_MandatoryIfApplicable.itemExists.d1e8246" as="xs:integer+"><xsl:sequence select="if(exists(/*/echo:ProcessingCenter)) then 1 else 0"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_MandatoryIfApplicable.itemExists.d1e8246)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:variable name="FGDC_MandatoryIfApplicable.itemCounts.d1e8246" as="xs:integer+"><xsl:sequence select="count(/*/echo:ProcessingCenter)"></xsl:sequence></xsl:variable><xsl:text>"</xsl:text><xsl:value-of select="'count'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="sum($FGDC_MandatoryIfApplicable.itemCounts.d1e8246)"></xsl:value-of><xsl:text>",
</xsl:text><xsl:text>
"paths" : [
</xsl:text><xsl:text>
{</xsl:text><xsl:text>"path":"/*/echo:ProcessingCenter",</xsl:text><xsl:text>"</xsl:text><xsl:value-of select="'exists'"></xsl:value-of><xsl:text>":"</xsl:text><xsl:value-of select="if(exists(/*/echo:ProcessingCenter)) then 1 else 0"></xsl:value-of><xsl:text>",
